...
// Re-exported from the store-free layout module (./nurseryLayout) to break the
// gardenStore → scene/nurseryScene → adapter import cycle. Existing consumers
// can keep importing these from the adapter.
export { nurseryWorldBounds, TRAY_GUTTER_IN, TRAYS_PER_COLUMN, trayWorldOrigin };
