...
- [ ] Re-enable Optimize Layout in `PropertiesPanel.tsx` (currently gated behind `false &&`). Disabled until the simplified solver (post-2026-05-05 refactor that cut companion/trellis/region/cohesion terms) has been validated end-to-end in the UI on a few real beds.
